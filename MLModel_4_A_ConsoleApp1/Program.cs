...
Console.WriteLine("Using model to make single prediction -- Comparing actual FTAG with predicted FTAG from sample data...\n\n");
...
Console.WriteLine($"\n\nPredicted FTAG: {predictionResult.PredictedLabel}\n\n");
